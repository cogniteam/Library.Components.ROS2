...
def launch_setup(context, *args, **kwargs):
    ...
    zed_wrapper_node = Node(
        ...
        remappings=[
            (f'/{camera_model_val}/joint_states', '/zed2/joint_states'),
            (f'/{camera_model_val}/zed_node/confidence/confidence_map', '/zed2/zed_node/confidence/confidence_map'),
            (f'/{camera_model_val}/zed_node/depth/camera_info', '/zed2/zed_node/depth/camera_info'),
            (f'/{camera_model_val}/zed_node/depth/depth_registered', '/zed2/zed_node/depth/depth_registered'),
            (f'/{camera_model_val}/zed_node/imu/data', '/zed2/zed_node/imu/data'),
            (f'/{camera_model_val}/zed_node/imu/data_raw', '/zed2/zed_node/imu/data_raw'),
            (f'/{camera_model_val}/zed_node/odom', '/zed2/zed_node/odom'),
            (f'/{camera_model_val}/zed_node/point_cloud/cloud_registered', '/zed2/zed_node/point_cloud/cloud_registered'),
            (f'/{camera_model_val}/zed_node/rgb/camera_info', '/zed2/zed_node/rgb/camera_info'),
            (f'/{camera_model_val}/zed_node/rgb/image_rect_color', '/zed2/zed_node/rgb/image_rect_color'),
            (f'/{camera_model_val}/zed_node/rgb/image_rect_gray', '/zed2/zed_node/rgb/image_rect_gray'),
            (f'/{camera_model_val}/zed_node/rgb_raw/camera_info', '/zed2/zed_node/rgb_raw/camera_info'),
            (f'/{camera_model_val}/zed_node/rgb_raw/image_raw_color', '/zed2/zed_node/rgb_raw/image_raw_color'),
            (f'/{camera_model_val}/zed_node/rgb_raw/image_raw_gray', '/zed2/zed_node/rgb_raw/image_raw_gray'),
            (f'/{camera_model_val}/zed_node/stereo/image_rect_color', '/zed2/zed_node/stereo/image_rect_color'),
            (f'/{camera_model_val}/zed_node/stereo_raw/image_raw_color', '/zed2/zed_node/stereo_raw/image_raw_color'),
        ]
    )
