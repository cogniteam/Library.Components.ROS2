...
def generate_launch_description():
    ...
    frame_id = DeclareLaunchArgument('laser_frame',
                                        default_value="laser_data_frame",
                                        description='laser_data_frame')
    lidar_ip = DeclareLaunchArgument('lidar_ip',
                                        default_value="192.168.1.100",
                                        description='lidar_ip')
    computer_ip = DeclareLaunchArgument('computer_ip',
                                        default_value="192.168.1.10",
                                        description='computer_ip')
    lidar_port = DeclareLaunchArgument('lidar_port',
                                        default_value="2368",
                                        description='lidar_port')
    imu_port = DeclareLaunchArgument('imu_port',
                                    default_value="9866",
                                    description='imu_port')
